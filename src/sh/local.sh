...
export EMETER_APP_URL='192.168.25.128:8080';
...
cp -v ${ORIGIN}/resources/tomcat/tomcat-users.xml ${TOMCAT}/conf/tomcat-users.xml;
cp -v ${ORIGIN}/resources/tomcat/manager-context.xml ${TOMCAT}/webapps/manager/META-INF/context.xml;
cp -v ${ORIGIN}/resources/tomcat/manager-context.xml ${TOMCAT}/webapps/host-manager/META-INF/context.xml;
cp -v ${ORIGIN}/resources/tomcat/context.xml ${TOMCAT}/conf/;
cp -v ${ORIGIN}/resources/tomcat/server.xml ${TOMCAT}/conf/;
cp -v ${ORIGIN}/resources/tomcat/web.xml ${TOMCAT}/conf/;
cp -v ${ORIGIN}/resources/maven/settings.xml ${MAVEN}/;

# Dependências provided
cp -v -r ${ORIGIN}/tomcat-libs/* ${TOMCAT}/lib/;
